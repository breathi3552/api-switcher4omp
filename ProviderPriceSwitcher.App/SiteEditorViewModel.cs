...
public sealed class SiteEditorViewModel : ObservableObject
{
    ...
    private readonly ISiteCredentialStore _credentials;
    ...
    public SiteEditorViewModel(PricingProbeUseCase probe, IPricingAdapterRegistry registry, ISiteCredentialStore credentials, IUserNotificationService notifications, LocalAppSettings settings, SiteConfiguration? original = null)
    {
        _probe = probe; _credentials = credentials; _notifications = notifications; _settings = settings; _original = original; Descriptors = registry.Descriptors;
