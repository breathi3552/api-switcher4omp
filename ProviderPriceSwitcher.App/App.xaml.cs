...
public partial class App : System.Windows.Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            var editorFactory = new SiteEditorDialogFactory((session, localSettings) => new SiteEditorViewModel(session, new PricingProbeUseCase(adapterRegistry), credentialStore, _notifications, localSettings, inferenceKeyUseCase), adapterRegistry);
