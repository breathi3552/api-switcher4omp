...
public partial class App : System.Windows.Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            var editorFactory = new SiteEditorDialogFactory(session => new SiteEditorViewModel(session), new PricingProbeUseCase(adapterRegistry), adapterRegistry, credentialStore, _notifications, inferenceKeyUseCase);
